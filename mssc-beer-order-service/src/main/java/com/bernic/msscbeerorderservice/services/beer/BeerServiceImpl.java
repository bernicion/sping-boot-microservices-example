...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerServiceImpl(RestTemplateBuilder restTemplateBuilder,
                           @Value("${sfg.brewery.service-user}") String beerServiceUser,
                           @Value("${sfg.brewery.service-password}") String beerServicePassword) {
        this.restTemplate = restTemplateBuilder
                .basicAuthentication(beerServiceUser, beerServicePassword)
                .build();
    }
